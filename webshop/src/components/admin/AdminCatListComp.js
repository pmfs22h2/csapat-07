        ...
        <table>
            {Object.values(category).map(cat => (
                <tr>
                    <td>{cat.name}</td>
                    <td>{cat.id}</td>
                    <button className="admin-button"><Link className="admin-link" to={`/kategoriak/${cat.id}/torles`} >Törlés</Link></button>
                    <button className="admin-button"><Link className="admin-link" to={`/admin/kategoriak/${cat.id}/modositas`} >Szerkesztés</Link></button>
                </tr>
            ))}
        </table>
    )
